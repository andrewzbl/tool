...
public class Snowflake {
    ...
    /**
     * A snowflake is designed to operate as a singleton instance within the context of a node. If you deploy different nodes, supplying a unique node id
     * will guarantee the uniqueness of ids generated concurrently on different nodes.
     *
